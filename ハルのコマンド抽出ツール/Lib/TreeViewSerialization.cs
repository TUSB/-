        ...
        public class TreeViewSerializer
        {
                ...
                XmlTextWriter textWriter)
            {
                for (int i = 0; i < nodesCollection.Count; i++)
                {
                    ...
                    if (node.Tag != null)
                    {
                        var compound = (NBTTagCompound)node.Tag;
                        ...
                        textWriter.WriteAttributeString(XmlNodeTagAtt, json);
                    }
            ...
            private void SetAttributeValue(TreeNode node, string propertyName, string value)
            {
                ...
                {
                    var xml = System.Web.HttpUtility.UrlDecode(value);
                    var compound = NBTFile.FromJson(xml);
                    node.Tag = compound;
                }
            }
